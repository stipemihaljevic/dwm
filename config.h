...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-m", "0", "-fn", dmenufont, "-nb", col_1, "-nf", col_2, "-sb", col_1, "-sf", col_2, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,          spawn,                  SHCMD ("flameshot gui -p /home/stipe/Pictures")},
